class ItemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @item.save
        format.html { redirect_to list_path(@item.list), notice: 'Item was successfully created.' }
  ...
  def destroy
    @item.destroy
    respond_to do |format|
      format.html { redirect_to list_path(@item.list), notice: 'Item was successfully destroyed.' }
